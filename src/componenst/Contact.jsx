            ...
            <div className="space-y-6">
              <div className="flex items-center gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-slate-500">osama@example.com</p>
                </div>
              </div>
            ...
            <form ref={form} onSubmit={sendEmail} className="bg-[#141414] border border-white/10 p-8 lg:p-10 rounded-[2.5rem] shadow-2xl space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="form-control">
                  ...
                  <input type="text" placeholder="Osama" className="input bg-[#0a0a0a] border-white/5 focus:border-blue-600 focus:outline-none rounded-xl text-white w-full h-14" />
                </div>
                <div className="form-control">
                  <label className="label"><span className="label-text text-slate-400 font-bold uppercase text-[10px]">Email Address</span></label>
                  <input type="email" placeholder="osama@example.com" className="input bg-[#0a0a0a] border-white/5 focus:border-blue-600 focus:outline-none rounded-xl text-white w-full h-14" />
                </div>
              </div>

              <div className="form-control">
                <label className="label"><span className="label-text text-slate-400 font-bold uppercase text-[10px]">Your Message</span></label>
                <textarea className="textarea bg-[#0a0a0a] border-white/5 focus:border-blue-600 focus:outline-none rounded-xl text-white w-full h-32 resize-none" placeholder="Tell me about your project..."></textarea>
              </div>
