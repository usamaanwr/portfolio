export const Education = () => {
  const eduData = [
    ...
    { degree: "BS Computer Science", institute: "Virtual University of Pakistan", year: "2026 - Present" },
  ...
  return (
    <section id="education" className="py-20 bg-[#0a0a0a] px-6 lg:px-20 border-t border-white/5">
      <div className="container max-w-6xl mx-auto px-6">
        <h2 className="text-3xl font-black text-white mb-12 text-center uppercase tracking-tighter ">Education</h2>
